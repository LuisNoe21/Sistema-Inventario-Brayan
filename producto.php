<?php
	...
	if (isset($_POST['reference_remove']) and isset($_POST['quantity_remove'])){
		...
		$user_id=$_SESSION['user_id'];
		$firstname=$_SESSION['firstname'];
		$nota="$firstname sacó $quantity producto(s) del inventario";
		$fecha=date("Y-m-d H:i:s");
		guardar_historial($id_producto,$user_id,$fecha,$nota,$reference,$quantity);
            ...
            <div class="row">
              ...
              <div class="col-sm-4 text-left">
				...
				<div class="col-sm-12 margin-btm-10">
                      <span class="item-number"><b>ID: </b> <?php echo $row['codigo_producto'];?></span>
                    </div>
                    <div class="col-sm-12">
                      <span style="font-size: 20px;" class="item-title">Nombre: <?php echo $row['nombre_producto'];?></span>
                    </div>
